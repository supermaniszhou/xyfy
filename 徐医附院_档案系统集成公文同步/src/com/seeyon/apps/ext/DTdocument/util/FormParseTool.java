 ...
 * </p>
 */
public class FormParseTool {

    private static final Log LOGGER = LogFactory.getLog(FormParseTool.class);
    ...
    private static void copyV3xFile(V3XFile ctpFile, String folder) throws Exception {
        ...
        String filePath = FormParseTool.getDirectory(urls, createDates, mimeTypes, names);
    ...
    private static FormParseExtInfo formatFormContent(EdocSummary summary, Long actorId, boolean toHTML, String tempFile, CtpAffair affair, boolean canSeeMyselfOpinion) throws BusinessException {
        ...
        // 手写签批信息获取
        List<V3xHtmDocumentSignature> handWrites = v3xHtmDocumentSignatManager.findBySummaryIdAndType(summary.getId(),
        ...
        while (matcherSpan.find()) {
            ...
            String commonCss = ";overflow-x:hidden;overflow-y:auto;white-space:normal;word-break: break-word;word-wrap: break-word;border:0px;height:auto;color:#000000;"
                    + minHeight;
                            ...
                            if (toHTML) {
                                ...
                                while (signm.find()) {
                                    ...
                                    if (Strings.isNotBlank(srcId)) {
                                        ...
                                        V3xHtmDocumentSignature signet = v3xHtmDocumentSignatManager.getById(id);
                                        if (signet != null) {
                                    ...
                                    if (("hw" + field).equals(filedName) && optionValue.indexOf(opinionLocation) != -1) {
                                        ...
                                        if (toHTML) {
                                            ...
                                            if (signPicByte != null) {
                                                ...
                                                String imgStr = ResourceUtil.getString("govdoc.signal.text") + tempFile + "/" + fileName + "\">";
                                            ...
                                            String imgStr = ResourceUtil.getString("govdoc.signal.text") + imgSrc + "\" id=\"" + affairId + "\">";
                                            // optionValue = optionValue.replace(opinionLocation, imgStr + opinionLocation);
    ...
    private static FormParseExtInfo formatFormContent2(EdocSummary summary, Long actorId, boolean toHTML, String tempFile, String fFolder, CtpAffair affair, boolean canSeeMyselfOpinion) throws BusinessException {
        ...
        Map<String, Object> optionMap = ExEdocOpinionDisplayUtil.convertOpinionToString(field2OptionMap, displayConfig,
        ...
        while (matcherSpan.find()) {
            ...
            String commonCss = ";overflow-x:hidden;overflow-y:auto;white-space:normal;word-break: break-all;word-wrap: break-word;border:0px;height:auto;color:#000000;"
                    + minHeight;
            ...
            if (Strings.isNotBlank(options)) {
                ...
                while (signm.find()) {
                    ...
                    if (Strings.isNotBlank(srcId)) {
                        ...
                        V3xHtmDocumentSignature signet = v3xHtmDocumentSignatManager
                                .getById(id);
                        if (signet != null) {
                            String body = signet.getFieldValue();
                            byte[] b = EdocHelper.hex2byte(body);
                ...
                if (Strings.isNotEmpty(handWrites)) {
                    ...
                    for (V3xHtmDocumentSignature handWrite : handWrites) {
                        ...
                        if (("hw" + field).equals(filedName)
                            ...
                            if (signPicByte != null) {
                                extInfo.addByteFile(fileName, signPicByte);
                                String imgStr = ResourceUtil.getString("govdoc.signal.text")
                                        + tempFile + "/" + fileName
